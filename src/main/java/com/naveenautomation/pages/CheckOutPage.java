...
public class CheckOutPage extends TestBase {
	...
	public void selectCountryFromDropdown(WebElement element, String visibleText) {
		Select sc= new Select(element);
		sc.selectByVisibleText(visibleText);
	}

	public void selectStateFromDropdown(WebElement element, String visibleText) {
		Select sc = new Select(element);
		sc.selectByVisibleText(visibleText);

	}

	public void fillAndSubmitBillingDetails(String fName, String lName, String address1, String city, String pinCode,
		...
		selectCountryFromDropdown(countrySelection, countryname);
		
		stateSelection.click();
		selectStateFromDropdown(stateSelection, stateName);
